...
namespace ECommerceParser.Parsers.Common
{
    public abstract class GenericParser<TImportFile, TProductFile, TProductVariantsFile>
    {
        ...
        public abstract Task<(TProductFile productFile, TProductVariantsFile productVariantsFile)> ParseProducts(TImportFile importObject, string sourceLanguageCode);
    }
}
